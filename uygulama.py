"""
uygulama.py — Project Antigravity: Kapsamlı Streamlit Sohbet Arayüzü
====================================================================
Özellikler:
...
from core.yukleyici import (
    foundry_vektor_istemcisi_olustur,
    dosya_yukle,
    dosya_oku,
)
from core.arama_motoru import ilgili_parcalari_getir, hibrit_getir
from core.ureteci import (
